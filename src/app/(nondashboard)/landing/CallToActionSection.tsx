        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div>
            <p className="text-white mb-3">
              Discover a wide range of rental in location locationl ocationlo
              cation
            </p>
            <div className="flex justify-center md:justify-start gap-4">
              ...
              <Link
                href={"/signup"}
                className="inline-block text-white bg-secondary-500 rounded-lg px-6 py-3
              font-semibold hover:bg-secondary-600"
                scroll={false}
              >
                Sign up
              </Link>
